...
<div class="d-flex justify-content-center">
  <div>{% include figure.liquid path="assets/img/brazil.png" class="img-fluid rounded z-depth-1" %}</div>
</div>
<div class="caption">
...
<div class="d-flex justify-content-center">
  <div>{% include figure.liquid path="assets/img/growth.png" class="img-fluid rounded z-depth-1" %}</div>
</div>
<div class="caption">
