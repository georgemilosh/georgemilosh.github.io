...
> "What is needed is Validation, validation, validation." - Jasmina Magdalenic, during the meeting.
...
<div class="d-flex justify-content-center">
  <div>{% include figure.liquid path="assets/img/tdm1.jpeg" class="img-fluid rounded z-depth-1" %}</div>
</div>
<div class="caption">
...
We had productive discussion with Vigil mission scientist [Matthew West](https://www.solarnet-project.eu/matthew-j-west) regarding the need of **onboard processing and autonomy** for future space missions.
...
<div class="d-flex justify-content-center">
  <div>{% include figure.liquid path="assets/img/rs=w-1280.webp" class="img-fluid rounded z-depth-1" %}</div>
</div>
<div class="caption">
...
<div class="d-flex justify-content-center">
  <div>{% include figure.liquid path="assets/img/rs=w-12802.webp" class="img-fluid rounded z-depth-1" %}</div>
</div>
<div class="caption">
