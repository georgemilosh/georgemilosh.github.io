...
authors:
  ...
  - name: Ekaterina Dineva
    ...
    affiliations:
      name: CmPA, KU Leuven
  - name: Stefaan Poedts
    url: "https://perswww.kuleuven.be/~u0002601/"
    affiliations:
      name: CmPA, KU Leuven
...
Together with my colleagues Panagiotis Gonidakis and Ekaterina Dineva, I had the pleasure of moderating and organizing the Topical Discussion Meeting [Scientific Outlooks for the Analysis of Space Weather Data in the Age of AI](https://events.spacepole.be/event/222/sessions/599/#20251030), held during the ESWW conference in Umeå. Our panelists, Jasmina Magdalenic, Hannah Theresa Rüdisser, Matthew West, and Savvas Raptis, have covered a range of topics, from the transition of AI tools from research to operations, physics-informed learning, AI on board space missions, and foundation models. Below I summarise the key points from the discussion.
